...
<?php }
            ...
            title="<?php echo __('Support Center'); ?>">
                ...
                <img src="<?php echo ROOT_PATH; ?>logo.php?<?php echo strtotime($cfg->lastModified('logo_id')); ?>" border=0 alt="Allianza Infoway Pvt Ltd" onerror="this.onerror=null;this.src='<?php echo ROOT_PATH; ?>assets/default/images/logo.png';">
            </a>
        </div>
        <div class="clear"></div>
        <?php
